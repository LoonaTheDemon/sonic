...
idleoffsets = {'80', '0'} -- I recommend you have your idle offset at 0
leftoffsets = {'133', '-62'}
downoffsets = {'130', '-67'}
upoffsets = {'54', '50'}
rightoffsets = {'-40', '-25'}
...
idle_xml_name = 'Knux Idle'
left_xml_name = 'Knux Right'
down_xml_name = 'Knux Down'
up_xml_name = 'Knux Up'
right_xml_name = 'Knux left'
...
name_of_character_xml = 'Knuckles_Censored'
name_of_character = 'knuckles'
name_of_notetype = 'knuckles'
