...
idle_xml_name = 'Tails IDLE'
left_xml_name = 'Tails LEFT'
down_xml_name = 'Tails DOWN'
up_xml_name = 'Tails UP'
right_xml_name = 'Tails RIGHT'
...
name_of_character_xml = 'tails_censored'
name_of_character = 'tails'
name_of_notetype = 'tails'
